(function () {
    ...
    var table = new Tabulator("#edit-table", {
        ...
        columns: [
            ...
            { title: "Position", field: "position", editor:"list", editorParams:{autocomplete:"true", allowEmpty:true,listOnEmpty:true, valuesLookup:true} },
            { title: "Office", field: "office", editor:"list", editorParams:{autocomplete:"true", allowEmpty:true,listOnEmpty:true, valuesLookup:true} },
            { title: "Age", field: "age", editor: "input" },
            { title: "Salary", field: "salary", editor: "input" },
        ],
    });
    ...
    var table = new Tabulator("#validation-table", {
        ...
        columns: [
            ...
            { title: "Position", field: "position", editor:"list", editorParams:{autocomplete:"true", allowEmpty:true,listOnEmpty:true, valuesLookup:true}, validator:"required"},
            { title: "Office", field: "office", editor:"list", editorParams:{autocomplete:"true", allowEmpty:true,listOnEmpty:true, valuesLookup:true},validator:"required" },
            { title: "Age", field: "age", editor: "input", validator:["min:20", "max:50", "integer"]},
            { title: "Salary", field: "salary", editor: "input", validator:["min:100000", "max:1500000", "integer"]},
        ],
    });
