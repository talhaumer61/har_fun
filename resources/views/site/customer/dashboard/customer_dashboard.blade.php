        ...
        <div class="row">
            <div class="col-lg-6 col-6">
                <div class="dash-card-one bg-white border-30 position-relative mb-15">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <div class="icon rounded-circle d-flex align-items-center justify-content-center order-sm-1"><img src="{{asset('site/dashboard/icon/icon_12.svg')}}" alt="" class="lazy-img"></div>
                        <div class="order-sm-0">
                            <div class="value fw-500">{{ $jobCount }}</div>
            ...
            <div class="col-lg-6 col-6">
                <div class="dash-card-one bg-white border-30 position-relative mb-15">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <div class="icon rounded-circle d-flex align-items-center justify-content-center order-sm-1"><img src="{{asset('site/dashboard/icon/icon_13.svg')}}" alt="" class="lazy-img"></div>
                        <div class="order-sm-0">
            ...
            <div class="col-lg-6 col-6">
                <div class="dash-card-one bg-white border-30 position-relative mb-15">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <div class="icon rounded-circle d-flex align-items-center justify-content-center order-sm-1"><img src="{{asset('site/dashboard/icon/icon_14.svg')}}" alt="" class="lazy-img"></div>
                        <div class="order-sm-0">
            ...
            <div class="col-lg-6 col-6">
                <div class="dash-card-one bg-white border-30 position-relative mb-15">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <div class="icon rounded-circle d-flex align-items-center justify-content-center order-sm-1"><img src="{{asset('site/dashboard/icon/icon_15.svg')}}" alt="" class="lazy-img"></div>
                        <div class="order-sm-0">
        ...
        <div class="row d-flex pt-50 lg-pt-10">
            <div class="col-xl-7 col-lg-6 d-flex flex-column">
                <div class="user-activity-chart bg-white border-20 mt-30 h-100">
                    ...
                    <div class="ps-5 pe-5 mt-50"><img src="{{asset('site/dashboard/main-graph.png')}}" alt="" class="lazy-img m-auto"></div>
                </div>
            </div>
                ...
                <div class="recent-job-tab bg-white border-20 mt-30 w-100">
                    ...
                    <div class="wrapper">
                        <div class="job-item-list d-flex align-items-center">
                            <div><img src="{{asset('site/images/logo/media_22.png')}}" alt="" class="lazy-img logo"></div>
                            <div class="job-title">
                        ...
                        <!-- /.job-item-list -->
                        <div class="job-item-list d-flex align-items-center">
                            <div><img src="{{asset('site/images/logo/media_23.png')}}" alt="" class="lazy-img logo"></div>
                            <div class="job-title">
                        ...
                        <!-- /.job-item-list -->
                        <div class="job-item-list d-flex align-items-center">
                            <div><img src="{{asset('site/images/logo/media_24.png')}}" alt="" class="lazy-img logo"></div>
                            <div class="job-title">
                        ...
                        <!-- /.job-item-list -->
                        <div class="job-item-list d-flex align-items-center">
                            <div><img src="{{asset('site/images/logo/media_25.png')}}" alt="" class="lazy-img logo"></div>
                            <div class="job-title">
                        ...
                        <!-- /.job-item-list -->
                        <div class="job-item-list d-flex align-items-center">
                            <div><img src="{{asset('site/images/logo/media_26.png')}}" alt="" class="lazy-img logo"></div>
                            <div class="job-title">
