<section class="feedback-section-one pt-180 xl-pt-150 lg-pt-100 pb-80 lg-pb-20">
    <div class="container position-relative">
        ...
        {{-- <div class="partner-logos border-0 pt-150 xl-pt-120 md-pt-80 sm-pt-40 pb-80 lg-pb-40">
            <div class="partner-slider">
                ...
                <div class="item">
                    <div class="logo d-flex align-items-center"><img src="{{asset('site/images/logo/media_04.png')}}" alt=""></div>
                </div>
                <div class="item">
                    <div class="logo d-flex align-items-center"><img src="{{asset('site/images/logo/media_05.png')}}" alt=""></div>
                </div>
                <div class="item">
                    <div class="logo d-flex align-items-center"><img src="{{asset('site/images/logo/media_06.png')}}" alt=""></div>
                </div>
                <div class="item">
                    <div class="logo d-flex align-items-center"><img src="{{asset('site/images/logo/media_07.png')}}" alt=""></div>
                </div>
                <div class="item">
                    <div class="logo d-flex align-items-center"><img src="{{asset('site/images/logo/media_08.png')}}" alt=""></div>
                </div>
                <div class="item">
                    <div class="logo d-flex align-items-center"><img src="{{asset('site/images/logo/media_05.png')}}" alt=""></div>
                </div>
