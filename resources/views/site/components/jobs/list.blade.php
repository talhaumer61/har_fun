                ...
                <div class="job-post-item-wrapper">
                    ...
                    <div class="accordion-box list-style">
                            ...
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_22.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Developer & expert in java c++</a>
                                    </div>
                                </div>
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_23.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Animator & Expert in maya 3D </a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                    <a href="job-details-v2.html" class="job-duration fw-500 part-time">Part Time</a>
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_24.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Marketing Specialist in SEO & SMM</a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                    <a href="job-details-v2.html" class="job-duration fw-500 part-time">Part Time</a>
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_25.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Developer & expert in java c++</a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_26.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Lead & Product Designers.</a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                    <a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a>
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_33.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Email Marketing & App Integrations</a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                    <a href="job-details-v2.html" class="job-duration fw-500 part-time">Part Time</a>
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_34.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Outbound Call Service Web shop </a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                    <a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a>
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_35.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Build Responsive Website From Scratch</a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                    <a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a>
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_36.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Document typing (easy typing)</a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                    <a href="job-details-v2.html" class="job-duration fw-500 part-time">Part Time</a>
                        ...
                        <div class="job-list-one style-two position-relative border-style mb-20">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-xl-3 col-lg-4">
                                    <div class="job-title d-flex align-items-center">
                                        <a href="job-details-v2.html" class="logo md-mb-20"><img src="{{asset('site/images/logo/media_37.png')}}" alt="" class="lazy-img m-auto"></a>
                                        <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">General Ledger & Marketing Specialist</a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                    <a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a>
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_22.png')}}" alt="" class="lazy-img m-auto"></a>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_23.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_24.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                    <div><a href="job-details-v2.html" class="job-duration fw-500 part-time">Part-time</a></div>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_25.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                    <div><a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a></div>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_26.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                    <div><a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a></div>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_33.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                    <div><a href="job-details-v2.html" class="job-duration fw-500 part-time">Part-time</a></div>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_34.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                    <div><a href="job-details-v2.html" class="job-duration fw-500 part-time">Part-time</a></div>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_35.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                    <div><a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a></div>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_36.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                    <div><a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a></div>
                                    <div><a href="job-details-v2.html" class="title fw-500 tran3s">Hotel Manager with PHD in Hms.</a></div>
                                    <div class="job-salary"><span class="fw-500 text-dark">$40k-$60k</span> / Year</div>
                            ...
                            <div class="col-lg-4 mb-30">
                                <div class="job-list-two position-relative">
                                    <a href="job-details-v2.html" class="logo"><img src="{{asset('site/images/logo/media_37.png')}}" alt="" class="lazy-img m-auto"></a>
                                    <a href="job-details-v2.html" class="save-btn text-center rounded-circle tran3s" title="Save Job"><i class="bi bi-bookmark-dash"></i></a>
                                    <div><a href="job-details-v2.html" class="job-duration fw-500 part-time">Part-time</a></div>
                    ...
                    <div class="pt-30 lg-pt-20 d-sm-flex align-items-center justify-content-between">
                        ...
                        <ul class="pagination-one d-flex align-items-center justify-content-center justify-content-sm-start style-none">
                            ...
                            <li><a href="#">4</a></li>
                            <li>....</li>
                            <li class="ms-2"><a href="#" class="d-flex align-items-center">Last <img src="{{asset('site/images/icon/icon_50.svg')}}" alt="" class="ms-2"></a></li>
                        </ul>
                    </div>
                </div>
