        ...
        <div class="bg-wrapper mt-60 lg-mt-40">
            <div class="tab-content" id="faqTabContent">
                ...
                <div class="tab-pane fade show active" id="faq-general" role="tabpanel">
                    <div class="accordion accordion-style-two" id="accordionGeneral">
                ...
                <!-- For Workers -->
                <div class="tab-pane fade" id="faq-workers" role="tabpanel">
                    <div class="accordion accordion-style-two" id="accordionWorkers">
                        <div class="accordion-item">
                            <div class="accordion-header">
                ...
                <!-- For Clients -->
                <div class="tab-pane fade" id="faq-clients" role="tabpanel">
                    <div class="accordion accordion-style-two" id="accordionClients">
                        <div class="accordion-item">
                            <div class="accordion-header">
                ...
                <!-- Payments -->
                <div class="tab-pane fade" id="faq-payments" role="tabpanel">
                    <div class="accordion accordion-style-two" id="accordionPayments">
                        <div class="accordion-item">
                            <div class="accordion-header">
                ...
                <div class="tab-pane fade" id="faq-support" role="tabpanel">
                    <div class="accordion accordion-style-two" id="accordionSupport">
                        <div class="accordion-item">
                            <div class="accordion-header">
